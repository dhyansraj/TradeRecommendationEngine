...
def store_all_symbols_on_db():
    ...
    close_manager.store_all_symbols_on_db_live()

    open_manager.store_all_symbols_on_db_live()

    high_manager.store_all_symbols_on_db_live()

    low_manager.store_all_symbols_on_db_live()
